...
function getWeather() {
  ...
  var xhttp = new XMLHttpRequest();
	xhttp.onreadystatechange = function() {
      ...
      //openweather does not supply feels like temp, so we'll calculate ourselves
      //heat index equation from http://www.wpc.ncep.noaa.gov/html/heatindex_equation.shtml
      var feelsLike = -42.379 + 2.04901523*temp + 10.14333127*humidity - .22475541*temp*humidity - .00683783*temp*temp - .05481717*humidity*humidity + .00122874*temp*temp*humidity + .00085282*temp*humidity*humidity - .00000199*temp*temp*humidity*humidity;
      ...
      if (temp > 79 && temp < 113 && humidity <13){
        ...
        if (temp > 80 && temp < 87 && humidity > 85) {
          feelsLike = feelsLike + ((humdity-85)/10)*((87-temp)/5);
        } else {
          if (temp < 80) {
      ...
      var dispFeelsLike = (Math.floor(feelsLike*100))/100;
